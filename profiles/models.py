...
class Profile(models.Model):
	...
	CV= models.FileField(upload_to=upload_location, null= False, blank=False)
	skills= models.CharField(max_length=200, null=True, blank=True)
	project= models.FileField(upload_to=upload_location, null= False, blank=False)
...
class UserJob(models.Model):
	...
	position = models.CharField(null= True, blank=True, max_length=220)
	location = models.CharField( null= True, blank=True, max_length=220)
	employer_name = models.CharField(null=True, blank=True, max_length=220)
